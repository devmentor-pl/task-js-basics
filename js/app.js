const startCalculator = (function (newCalculator) {
    ...
    Calculator.prototype.startLoop = function () {
        do {
            ...
            this.action = prompt(promptContent);
            let isCorrectAction = this.isCorrectAction(this.action);
            ...
            if (isCorrectAction) {
                ...
                if (this.checkIsNumber(number1) !== 0) {
                    ...
                    if (this.checkIsNumber(number2) !== 0) {
                        ...
                        this.makeOperation(this.action);
                        this.setHistoryAsString(this.action);
                    }
                }
            } else {
                this.clearHistoryInCalculator();
            }
        } while (this.isCorrectAction(this.action));
    }
